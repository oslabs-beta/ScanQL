...
const HelpModal: React.FC = () => {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger>
        <QuestionMarkCircledIcon className="text-indigo-900 text-opacity-70 help-modal-btn" width={25} height={25}  />
      </Dialog.Trigger>

      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-black/50" />

        <Dialog.Content className="fixed left-1/2 top-1/2 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-[20px]  p-8 text-gray-900 shadow help-modal">

          <div className="flex items-center justify-between">
            <Dialog.Title className="text-white text-opacity-90 m-0 text-[22px] font-medium text-center">
              How to Get Started
          ...
          <Dialog.Description className="text-white text-opacity-90 mt-[10px] mb-5 text-[14px] leading-normal">
