...
const TechStackBar = () => {
  return (
    <div className ="flex bg-white bg-opacity-10 rounded-[20px] mb-10">
        <img className = 'h-14 m-5'src = {reactlogo}></img>
        <img className = 'h-14 m-5'src = {nodelogo}></img>
        <img className = 'h-14 m-5'src = {postgresqllogo}></img>
        <img className = 'h-14 m-5' src = {expressjslogo}></img>
        <img className = 'h-14 m-5' src = {typescriptlogo}></img>
        <img className = 'h-14 m-5' src = {vitelogo}></img>
        <img className = 'h-14 m-5' src = {tailwindlogo}></img>
        <img className = 'h-14 m-5' src = {jestlogo}></img>
    </div>
  )
}
