  ...
  return (
    <div className='flex pr-6'>
      <Form.Root className="w-[260px] h-full" onSubmit={handleFormSubmit}>
        ...
        <Form.Submit asChild>
          <button className="box-border w-full rounded-lg font-normal mr-1 ml-1 bg-gray-500 bg-opacity-10 text-indigo-900 text-opacity-80 shadow-blackA7 hover:bg-mauve3 inline-flex h-[35px] items-center justify-center px-[15px] leading-none shadow-[0_2px_10px] focus:shadow-[0_0_0_2px] focus:shadow-black focus:outline-none mt-[10px]">
        Submit Query
          </button>
