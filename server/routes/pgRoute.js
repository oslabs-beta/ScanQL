...
pgRoute.post('/dbInfo', dbConnectionController.connectAndInitializeDB, dbConnectionController.createExtension, dbInfoController.getDataBaseInfo, dbERDcontroller.getSchemaPostgreSQL, genericMetricsController.performGenericQueries, dbOverviewController.dbSizeMetrics, dBHistoryController.dbPastMetrics, (_req, res) => {
    return res.status(200).json(res.locals);
});
pgRoute.post('/customQuery', customDBController.customQueryMetrics, 
//new controller
(_req, res) => {
